...
int main() {
    ...
    dfg.addNode(DomainFlowNode(DomainFlowOperator::MATMUL, "test.Matmul").addOperand("tensor<1x4x4xf16>").addOperand("tensor<1x4x4xf16>").addResult("out", "tensor<1x4x4xf16>"));
    dfg.addNode(DomainFlowNode(DomainFlowOperator::MATMUL, "test.Matmul").addOperand("tensor<1x4x4xf8>").addOperand("tensor<1x4x4xf8>").addResult("out", "tensor<1x4x4xf8>"));
    dfg.addNode(DomainFlowNode(DomainFlowOperator::MATMUL, "test.Matmul").addOperand("tensor<1x4x4xi32>").addOperand("tensor<1x4x4xi32>").addResult("out", "tensor<1x4x4xi32>"));
    dfg.addNode(DomainFlowNode(DomainFlowOperator::MATMUL, "test.Matmul").addOperand("tensor<1x4x4xi16>").addOperand("tensor<1x4x4xi16>").addResult("out", "tensor<1x4x4xi16>"));
    dfg.addNode(DomainFlowNode(DomainFlowOperator::MATMUL, "test.Matmul").addOperand("tensor<1x4x4xi8>").addOperand("tensor<1x4x4xi8>").addResult("out", "tensor<1x4x4xi8>"));
